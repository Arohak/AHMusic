...
let BLUE_LIGHT1                         = CLEAR // UIColor(red: 210/255,     green: 220/255,     blue: 240/255,      alpha: 1)
...
let AU_BTN_FONT                         = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 18     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 18     : DeviceType.IS_IPHONE_6 ? 18   * IPHONE_6_SCALE : 18   * IPHONE_5_SCALE)
let AU_FIELD_FONT                       = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 16     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 16     : DeviceType.IS_IPHONE_6 ? 16   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)
let AU_LBL_FONT                         = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 14     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 14     : DeviceType.IS_IPHONE_6 ? 14   * IPHONE_6_SCALE : 14   * IPHONE_5_SCALE)
...
let LM_LBL_FONT                         = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 12         * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 12     : DeviceType.IS_IPHONE_6 ? 12   * IPHONE_6_SCALE : 12   * IPHONE_5_SCALE)
...
let CA_ICON_SIZE : CGFloat              = DeviceType.IS_IPAD ? 60     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 60     : DeviceType.IS_IPHONE_6 ? 60   * IPHONE_6_SCALE : 60   * IPHONE_5_SCALE
let CA_CELL_WIDTH : CGFloat             = (ScreenSize.WIDTH - 4*CA_INSET)/2

let CA_TITLE_FONT                       = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 25     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 25     : DeviceType.IS_IPHONE_6 ? 25   * IPHONE_6_SCALE : 20   * IPHONE_5_SCALE)
...
let AL_TITLE_FONT                       = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 20     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 20     : DeviceType.IS_IPHONE_6 ? 20   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)
...
let AR_TITLE_FONT                       = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 20     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 20     : DeviceType.IS_IPHONE_6 ? 20   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)
...
let PL_TITLE_FONT                       = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 18     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 18     : DeviceType.IS_IPHONE_6 ? 18   * IPHONE_6_SCALE : 18   * IPHONE_5_SCALE)
let PL_DATE_FONT                        = UIFont.systemFont(ofSize: DeviceType.IS_IPAD ? 16     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 16     : DeviceType.IS_IPHONE_6 ? 16   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)
...
let TR_ICON_SIZE : CGFloat              = DeviceType.IS_IPAD ? 60     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 60     : DeviceType.IS_IPHONE_6 ? 60   * IPHONE_6_SCALE : 60   * IPHONE_5_SCALE
...
let TR_TITLE_FONT                       = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 18     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 18     : DeviceType.IS_IPHONE_6 ? 18   * IPHONE_6_SCALE : 18   * IPHONE_5_SCALE)
let TR_DESC_FONT                        = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 16     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 16     : DeviceType.IS_IPHONE_6 ? 16   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)

//MARK: - Detail Constants

let DE_CELL_HEIGHT : CGFloat            = DeviceType.IS_IPAD ? 70     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 70     : DeviceType.IS_IPHONE_6 ? 70   * IPHONE_6_SCALE : 70   * IPHONE_5_SCALE
let DE_HEADER_HEIGHT : CGFloat          = ScreenSize.HEIGHT*0.55

let DE_INFO_FONT                        = UIFont.boldSystemFont(ofSize: DeviceType.IS_IPAD ? 16     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 16     : DeviceType.IS_IPHONE_6 ? 16   * IPHONE_6_SCALE : 16   * IPHONE_5_SCALE)
...
let TD_BTN_SIZE : CGFloat               = DeviceType.IS_IPAD ? 40     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 40     : DeviceType.IS_IPHONE_6 ? 40   * IPHONE_6_SCALE : 40   * IPHONE_5_SCALE
let TD_BBTN_SIZE : CGFloat              = DeviceType.IS_IPAD ? 70     * IPAD_SCALE : DeviceType.IS_IPHONE_6P ? 70     : DeviceType.IS_IPHONE_6 ? 70   * IPHONE_6_SCALE : 70   * IPHONE_5_SCALE
let TD_HEIGHT : CGFloat                 = TD_BBTN_SIZE*3
